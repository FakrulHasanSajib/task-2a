...
<body class="bg-gray-100 p-8">
    ...
    <div class="max-w-6xl mx-auto bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="flex justify-between items-center mb-6">
            <a href="{{ route('products.create') }}" class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded flex items-center">
                    ...
                    @forelse($products as $index => $product)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="active-status">{{ $product->status ? 'Active' : 'Inactive' }}</span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    <a href="{{ route('products.edit', $product->id) }}" class="text-purple-600 hover:text-purple-800 transition-colors duration-200 p-1 rounded-md">
